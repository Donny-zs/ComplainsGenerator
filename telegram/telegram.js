    ...
    privateButton(command, chat_id, from){
        ...
        switch (command) {
            ...
            case 'postComplaint' :
                ...
                this.sendMessage(chat_id, `Пожалуйста пришлите пришедший ответ из департамента следующим сообщением в этот чат в виде текста, файла или скриншота(убедитесь что всё видно)`)
